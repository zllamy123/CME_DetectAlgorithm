...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["bifpn"]+d["head"]):  # from, number, module, args
        ...
        if m is BiFPN:
                in_channels = [ch[x] for x in f]  # Get input channels from previous layers
                out_channels = args[0]  # The first argument in args is the output channels
                m_ = BiFPN(in_channels, out_channels)  # Create BiFPN layer
        else:
